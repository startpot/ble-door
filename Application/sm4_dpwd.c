...
//					(Time & 0x00ff000000000000)/pow(2,48)*pow(2,8)+\
//					(Time & 0x0000ff0000000000)/pow(2,40)*pow(2,16)+\
//					(Time & 0x000000ff00000000)/pow(2,32)*pow(2,24)+\
//					(Time & 0x00000000ff000000)/pow(2,24)*pow(2,32)+\
//					(Time & 0x0000000000ff0000)/pow(2,16)*pow(2,40)+\
//					(Time & 0x000000000000ff00)/pow(2,8)*pow(2,48)+\
